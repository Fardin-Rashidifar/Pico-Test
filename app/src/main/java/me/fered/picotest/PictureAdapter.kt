...
class PictureAdapter(private var pictureList: List<Picture>) : RecyclerView.Adapter<PictureAdapter.CustomHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CustomHolder {
        ...
        val itemPictureBinding = DataBindingUtil.inflate<ItemPictureBinding>(layoutInflater, R.layout.item_picture, parent, false)
    ...
    class CustomHolder(private val itemPictureBinding: ItemPictureBinding, itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(picture: Picture, pictureList: List<Picture>) {
            ...
            itemPictureBinding.imageView.setImageDrawable(ContextCompat.getDrawable(itemView.context, R.drawable.pattern))
                        ...
                        if (LAST_CHOICE == null) {
                            ...
                            if (LAST_CHOICE!!.pair == picture.pair) {
                                ...
                                Timer().schedule(object : TimerTask() {
                                    override fun run() {
                                        LAST_CHOICE_ITEM_VIEW!!.setImageDrawable(ContextCompat.getDrawable(itemView.context, R.drawable.pattern))
                                        itemPictureBinding.imageView.setImageDrawable(ContextCompat.getDrawable(itemView.context, R.drawable.pattern))
                                        STOP = false
                                    }
                                }, 500)
